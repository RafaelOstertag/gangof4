...
const Color magenta{0xff, 0x0, 0xff, 0x0};
const Color blue{0x0, 0x0, 0xff, 0x0};
const Color orange{0xff, 0xa5, 0x0, 0x0};
const Color yellow{0xff, 0xff, 0x0, 0x0};
const Color green{0x0, 0xff, 0x0, 0x0};
const Color purple{0x80, 0x0, 0x80, 0x0};
const Color red{0xff, 0x0, 0x0, 0x0};
